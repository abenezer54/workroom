...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn("border-b border-border bg-surface-1 text-xs font-medium text-muted-foreground", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn("h-9 whitespace-nowrap px-4 py-2 text-left align-middle font-medium", className)}
    {...props}
  />
));
